...
to set-parameters
  ...
  [
    ...
    set ecol_brushFrequencyInflection ecol_grassFrequencyInflection + random-float 30
    set ecol_brushFrequencyRate 1E-3 + random-float 0.1

    set ecol_woodFrequencyInflection ecol_brushFrequencyInflection + random-float 70
...
to export-Fig7-terrains

  set type-of-experiment "random"

  foreach (list 32 298 304 499)
  [
    i ->
    set randomSeed i
    ...
    set display-mode "cover type"
    refresh-view
    export-view (word filePath "_coverTypes.png")
  ]
